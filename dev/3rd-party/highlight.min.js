...
begin:"(-?)(\\b0[xX][a-fA-F0-9_\']+|(\\b[\\d_\']+(\\.[\\d\']*)?|\\.[\\d\']+)([eE][-+]?[\\d\']+)?)"
}],relevance:0},c={className:"meta",begin:/#\s*[a-z]+\b/,end:/$/,keywords:{
keyword:"if else elif endif define undef warning error line pragma _Pragma program ifdef ifndef include"
...
keyword:["asm","auto","break","case","const","continue","default","do","else","enum", "exit", "extern","for","fortran","goto","halt", "if","inline","register","restrict","return","sizeof", "sleep", "static","struct","switch","typedef","union","volatile","while","_Alignas","_Alignof","_Atomic","_Generic","_Noreturn","_Static_assert","_Thread_local","alignas","alignof","noreturn","static_assert","thread_local","_Pragma"],
type:["float","double","signed","unsigned","int","short","long","char","void","_Bool","_Complex","_Imaginary","_Decimal32","_Decimal64","_Decimal128","complex","bool","imaginary"],
literal:"true false NULL",
built_in:"Get_A1 Get_A2 Get_A3 Get_A4 Get_B1 Get_B2 Get_B3 Get_B4 Set_A1 Set_A2 Set_A3 Set_A4 Set_A1_A2 Set_A3_A4 Set_B1 Set_B2 Set_B3 Set_B4 Set_B1_B2 Set_B3_B4 Clear_A Clear_B Clear_A_And_B Copy_A_From_B Copy_B_From_A Check_A_Is_Zero Check_B_Is_Zero Check_A_Equals_B Swap_A_and_B OR_A_with_B OR_B_with_A AND_A_with_B AND_B_with_A XOR_A_with_B XOR_B_with_A Add_A_To_B Add_B_To_A Sub_A_From_B Sub_B_From_A Mul_A_By_B Mul_B_By_A Div_A_By_B Div_B_By_A MD5_A_To_B Check_MD5_A_With_B HASH160_A_To_B Check_HASH160_A_With_B SHA256_A_To_B Check_SHA256_A_With_B Get_Block_Timestamp Get_Creation_Timestamp Get_Last_Block_Timestamp Put_Last_Block_Hash_In_A A_To_Tx_After_Timestamp Get_Type_For_Tx_In_A Get_Amount_For_Tx_In_A Get_Timestamp_For_Tx_In_A Get_Random_Id_For_Tx_In_A Message_From_Tx_In_A_To_B B_To_Address_Of_Tx_In_A B_To_Address_Of_Creator Get_Current_Balance Get_Previous_Balance Send_To_Address_In_B Send_All_To_Address_In_B Send_Old_To_Address_In_B Send_A_To_Address_In_B Add_Minutes_To_Timestamp"
