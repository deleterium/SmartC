/* Please note that these are secondary tests and will be removed any time */

import { CTestType, AssemblyTestType } from './testcases'

export const tests: CTestType [] = [
...
if (a<=pcar->collector) { b--; }`, false, '^declare r0\n^declare r1\n^declare r2\n^declare car\n^const SET @car #0000000000000004\n^declare car_0_driver\n^declare car_0_collector\n^declare car_0_passenger\n^declare car_1_driver\n^declare car_1_collector\n^declare car_1_passenger\n^declare pcar\n^declare a\n^declare b\n\nSET @pcar #0000000000000007\nSET @r0 $($pcar)\nSET @r1 #000000000000655a\nBNE $r0 $r1 :__if1_endif\n__if1_start:\nINC @b\n__if1_endif:\nSET @r1 #0000000000000001\nSET @r0 $($pcar + $r1)\nBGT $a $r0 :__if2_endif\n__if2_start:\nDEC @b\n__if2_endif:\nFIN\n'],
    ...
    [
        // Modifier on Function -> arr on pointer return value
        'long valLong = teste()[1]; long *teste(void) { long message[4]; return message; }',
        false,
    ...
    // #include APIFunctions\n long *next; void Send_Message(void) { Set_B1(-next);}
    // long *a[4], b, c; c = -a[b];
    [
    ...
    [
        // void pointer assigment
        'struct KOMBI { long driver; long collector; long passenger; } *pstruct; long *plong; void * pvoid; pvoid = plong; plong = pvoid; pvoid = pstruct; pstruct = pvoid;',
        false,
        '^declare r0\n^declare r1\n^declare r2\n^declare pstruct\n^declare plong\n^declare pvoid\n\nSET @pvoid $plong\nSET @plong $pvoid\nSET @pvoid $pstruct\nSET @pstruct $pvoid\nFIN\n'
    ],
    [
        // void pointer function arguments and return
...
void *ret(long *aa, void *bb) { aa++; return aa; }`,
    ...
    [
        // Array of pointers and double deference
        'long a, b, *c, *d[2]; c = d[1]; a = *d[1]; a++; c = d[b]; a = *d[b]; a++; d[0]=c; *d[1]=a; a++; d[b]=c; *d[b]=a;',
        false,
        '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare b\n^declare c\n^declare d\n^const SET @d #0000000000000007\n^declare d_0\n^declare d_1\n\nSET @c $d_1\nSET @a $d_1\nSET @a $($a)\nINC @a\nSET @c $($d + $b)\nSET @a $($d + $b)\nSET @a $($a)\nINC @a\nSET @d_0 $c\nSET @r0 $d_1\nSET @($r0) $a\nINC @a\nSET @($d + $b) $c\nSET @r0 $($d + $b)\nSET @($r0) $a\nFIN\n'
    ],
    [
        // Muldimensional arrays inside structs
        'struct KOMBI { long driver, collector, passenger[3][3]; } car; long a, b, c; car.passenger[2][2]=c; car.passenger[a][2]=c; car.passenger[2][b]=c; car.passenger[a][b]=c; c=car.passenger[2][2]; c=car.passenger[a][2]; c=car.passenger[2][b]; c=car.passenger[a][b];',
        false,
    ...
    [
        // Get property LENGTH of an array
        'long a, b[4], c[3][3]; struct KOMBI { long driver; long passenger[6]; } car[2]; a=b.length; a=c.length; a=car.length; a=car[1].passenger.length; a=car[a].passenger.length;',
        false,
    ...
    [
        // Get property LENGTH of an array in a struct pointer
        'long a; struct KOMBI { long driver; long passenger[6]; } *pcar; a=pcar->passenger.length;',
        false,
        '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare pcar\n\nSET @a #0000000000000006\nFIN\n'
    ],
    [
        // Recursive struct pointer declaration
...
a=pcar->collector;z++;*c=pcar->driver;d[1]=pcar->collector;d[a]=pcar->collector;`, false, '^declare r0\n^declare r1\n^declare r2\n^declare n1\n^const SET @n1 #0000000000000001\n^declare n2\n^const SET @n2 #0000000000000002\n^declare n3\n^const SET @n3 #0000000000000003\n^declare car_driver\n^declare car_collector\n^declare car_passenger\n^declare pcar\n^declare a\n^declare b\n^declare c\n^declare d\n^const SET @d #000000000000000e\n^declare d_0\n^declare d_1\n^declare z\n\nSET @pcar #0000000000000006\nSET @r0 #000000000000655a\nSET @($pcar + $n2) $r0\nSET @($pcar) $a\nCLR @r0\nSUB @r0 $a\nADD @b $r0\nSET @r0 #0000000000000005\nSET @($d) $r0\nCLR @a\n__loop1_condition:\nSET @r0 #000000000000000a\nBGE $a $r0 :__loop1_break\nSET @($d + $a) $n1\nINC @a\nJMP :__loop1_condition\n__loop1_break:\nSET @r0 $($c)\nSET @($pcar) $r0\nSET @($pcar) $d_1\nSET @r0 $($d + $a)\nSET @($pcar) $r0\nSET @r0 $($pcar + $n1)\nSET @($pcar) $r0\nSET @a $($pcar + $n1)\nINC @z\nSET @r0 $($pcar)\nSET @($c) $r0\nSET @d_1 $($pcar + $n1)\nSET @r0 $($pcar + $n1)\nSET @($d + $a) $r0\nFIN\n'],
    ...
    // bug 26 Keyword substring in variable name causing error
    ['long doing; doing++;', false, '^declare r0\n^declare r1\n^declare r2\n^declare doing\n\nINC @doing\nFIN\n'],
    //    [ "", false, "" ],
    ['End of tests!', null, '']
]

// params:  asmcode, expect error?, bytecode, bytedata
export const bytecodeTests: AssemblyTestType[] = [
    [
        'FIN\n',
        false,
        '28',
...
// params:  asmcode, expect error?, bytecode, bytedata
export const jestBytecodeTests: AssemblyTestType[] = [
    [
        // ok test (ok - ok)
        'FIN\n',
        false,
...
export const jestTests: CTestType [] = [
    [
        // ok test (ok - ok)
        'long a, b; a=b;',
        false,
