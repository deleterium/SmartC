    ...
    tests.forEach( (currentTest, index) => {
        ...
        try {
            ...
            if (currentTest[1] === false) {
                ...
                result+="<span style='color:red'>Fail...</span> (run OK) Code: <span style='color:purple'>"+encodedStr(currentTest[0])+"</span> Expected to throw exception but GOT\n"+code;
                itemFail++;
            }
        } catch (e) {
            if (currentTest[1] === true) {
                ...
                result+="<span style='color:red'>Fail...</span> (failed) Code: <span style='color:purple'>"+encodedStr(currentTest[0])+"</span>   GOT\n"+e;
                itemFail++;
            }
        }
