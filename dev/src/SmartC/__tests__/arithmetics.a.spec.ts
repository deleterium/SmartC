...
describe('Assignment / SetOperator', () => {
    ...
    it('should compile: += -= *= /= %= &= |= ^= <<= >>= ', () => {
        const code = '#pragma optimizationLevel 0\nlong a; long b; a+=b; a-=b; a*=b;a/=b;a%=b; a&=b; a|=b; a^=b; a<<=b; a>>=b;'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare b\n\nADD @a $b\nSUB @a $b\nMUL @a $b\nDIV @a $b\nMOD @a $b\nAND @a $b\nBOR @a $b\nXOR @a $b\nSHL @a $b\nSHR @a $b\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
...
describe('Constant', () => {
    ...
    it('should compile: accountRS', () => {
        const code = "#pragma optimizationLevel 0\nlong a; a='S-MKCL-2226-W6AH-7ARVS';"
    ...
    it('should compile: number with _ separator', () => {
        const code = '#pragma optimizationLevel 0\nlong a, b, c, d; a=5_0000_0000; b=5_0000_0000; c=0x00ff_00fe_7fff; d=0x00ff00fe7fff;'
    ...
    test('should throw: invalid RS decode', () => {
        expect(() => {
            const code = '#pragma optimizationLevel 0\nlong a = "TS-MPMZ-8CD9-HZMD-A7R1X";'
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
    test('should throw: invalid RS decode 2', () => {
        expect(() => {
            const code = '#pragma optimizationLevel 0\nlong a = "TS-MPMZ-8CD9-HZMD-A9R2X"'
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
