...
describe('Mix trying to break algorithm', () => {
    ...
    it('should compile: crazy mix', () => {
        const code = '#pragma optimizationLevel 0\nlong a, b, c, d, e, f, g, h; if (a==b&&c==d&&e==f&&g==h) { a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare b\n^declare c\n^declare d\n^declare e\n^declare f\n^declare g\n^declare h\n\nBNE $a $b :__if1_endif\n__AND_4_next:\nBNE $c $d :__if1_endif\nJMP :__AND_3_next\n__AND_3_next:\nBNE $e $f :__if1_endif\nJMP :__AND_2_next\n__AND_2_next:\nBNE $g $h :__if1_endif\nJMP :__if1_start\n__if1_start:\nINC @a\n__if1_endif:\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: crazy mix', () => {
        const code = '#pragma optimizationLevel 0\nlong a, b, c, d, e; if (a==0&&(b==0||c==0&&d==0)&&e==0) { a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare b\n^declare c\n^declare d\n^declare e\n\nBNZ $a :__if1_endif\n__AND_3_next:\nBZR $b :__AND_2_next\n__OR_4_next:\nBNZ $c :__if1_endif\n__AND_5_next:\nBNZ $d :__if1_endif\nJMP :__AND_2_next\nJMP :__if1_endif\nJMP :__AND_2_next\n__AND_2_next:\nBNZ $e :__if1_endif\nJMP :__if1_start\n__if1_start:\nINC @a\n__if1_endif:\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: crazy mix', () => {
        const code = '#pragma optimizationLevel 0\nlong a, b, c, d, z; if (( ( (a==5 || b==z) && c==z) || d==z ) && a==25+b) { a++; }'
