...
describe('Special functions', () => {
    it('should compile: main() no return', () => {
        const code = 'long a; void main(void) { a++; }'
    ...
    it('should compile: main() with return at end', () => {
        const code = 'long a; void main(void) { a++; return; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n\nJMP :__fn_main\n\n__fn_main:\nPCS\nINC @a\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: main() with return at middle', () => {
        const code = 'long a; void main(void) { a++; return; a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n\nJMP :__fn_main\n\n__fn_main:\nPCS\nINC @a\nFIN\nINC @a\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: catch() and no main function', () => {
        const code = 'long b, a = 0; while (true) { a++; } void catch(void) { long a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare b\n^declare a\n^declare catch_a\n\nERR :__fn_catch\nCLR @a\n__loop1_continue:\n__loop1_start:\nINC @a\nJMP :__loop1_continue\n__loop1_break:\nFIN\n\n__fn_catch:\nPCS\nINC @catch_a\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: catch() with return statement', () => {
        const code = 'long b, a = 0; void catch(void) { if (a) return; a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare b\n^declare a\n\nERR :__fn_catch\nCLR @a\nFIN\n\n__fn_catch:\nPCS\nBZR $a :__if1_endif\n__if1_start:\nFIN\n__if1_endif:\nINC @a\nFIN\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
...
describe('User defined functions', () => {
    it('should compile: void fun() with return at end', () => {
        const code = 'long a; void test(void) { a++; return; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n\nFIN\n\n__fn_test:\nINC @a\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: void fun() with return at middle', () => {
        const code = 'long a; void test(void) { a++; return; a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n\nFIN\n\n__fn_test:\nINC @a\nRET\nINC @a\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: calling void fun()', () => {
        const code = 'long a; test(); void test(void) { a++; return; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n\nJSR :__fn_test\nFIN\n\n__fn_test:\nINC @a\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: definition: fun(argument)', () => {
        const code = 'long a; void test2(long b) { b++; return; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare test2_b\n\nFIN\n\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: passing values in argument', () => {
        const code = 'long a; long test2(long b) { b++; return b; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare test2_b\n\nFIN\n\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nPSH $test2_b\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: passing values and getting return value', () => {
        const code = 'long a=0; a=test2(a); long test2(long b) { b++; return b; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare test2_b\n\nCLR @a\nPSH $a\nJSR :__fn_test2\nPOP @r0\nSET @a $r0\nFIN\n\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nPSH $test2_b\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: Ununsed function after main() (unreacheable code)', () => {
        const code = 'long a=0; void main(void){ a++; test2(a); exit; } void test2(long b) { b++; return; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare test2_b\n\nCLR @a\nJMP :__fn_main\n\n__fn_main:\nPCS\nINC @a\nPSH $a\nJSR :__fn_test2\nFIN\n\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    test('should throw: two functions with same name', () => {
        expect(() => {
            const code = 'long a=0; long b; a++; void test(void) { a++; } long tt(void) { a++;} long test(void) {a++; return a; }'
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
    ...
    test('should throw: wrong variable types on function arguments', () => {
        expect(() => {
            const code = 'long a, b; teste(a, b); void teste(long *fa, long fb) { fb++; }'
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
    ...
    it('should compile: check variable types on function arguments', () => {
        const code = 'long * a, b; teste(a, *a); void teste(long *fa, long fb) { fb++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare b\n^declare teste_fa\n^declare teste_fb\n\nSET @r0 $($a)\nPSH $r0\nPSH $a\nJSR :__fn_teste\nFIN\n\n__fn_teste:\nPOP @teste_fa\nPOP @teste_fb\nINC @teste_fb\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: check variable types on function arguments', () => {
        const code = 'long * a, b; teste(&b, b); void teste(long *fa, long fb) { fb++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n^declare b\n^declare teste_fa\n^declare teste_fb\n\nPSH $b\nSET @r0 #0000000000000004\nPSH $r0\nJSR :__fn_teste\nFIN\n\n__fn_teste:\nPOP @teste_fa\nPOP @teste_fb\nINC @teste_fb\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
    ...
    it('should compile: Support SetUnaryOperator in struct members', () => {
        const code = 'struct KOMBI { long driver; long collector; long passenger[4]; } car; long a, b; ++car.driver; a=car.collector++;'
    ...
    test('should throw: Support SetUnaryOperator in struct members, but not if it is an array', () => {
        expect(() => {
            const code = 'struct KOMBI { long driver; long collector; long passenger[4]; } car; long a, b; ++car.passenger[a]; '
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
    it('should compile: Function returning struct pointer', () => {
        const code = 'struct KOMBI { long driver, collector, passenger; } *val; val = teste(); val = test2(); struct KOMBI *teste(void) { struct KOMBI tt2; return &tt2; } struct KOMBI *test2(void) { struct KOMBI *stt2; return stt2; }'
    ...
    test('should throw: Error check Function return pointer', () => {
        expect(() => {
            const code = 'struct KOMBI { long driver, collector, passenger; } *val; val = teste(); struct KOMBI *teste(void) { struct KOMBI tt2; return tt2; }'
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
    it('should compile: Recursive functions', () => {
        const code = 'long a; long counter = 0; a = fibbonacci(12); \nlong fibbonacci(long n) {if(n == 0){ return 0; } else if(n == 1) { return 1; } else { return (fibbonacci(n-1) + fibbonacci(n-2)); } }'
    ...
    it('should compile: function with void_ptr arguments and return', () => {
        const code = `struct KOMBI { long driver; long collector; long passenger; } *pstruct; long *plong; void * pvoid;
...
void *ret(long *aa, void *bb) { aa++; return aa; }`
    ...
    it('should compile: function returning NULL pointer, return of long_ptr at function returning void pointer, Assign this return value to a long_ptr', () => {
        const code = 'long *plong; plong = malloc(); void *malloc(void) { if (current >=20) { return NULL; } long current++; long mem[20]; return (&mem[current]); }'
    ...
    test('should throw: Wrong arguments', () => {
        expect(() => {
            const code = 'long a, b; test(); void test() { c++; }'
            const compiler = new SmartC({ language: 'C', sourceCode: code })
            compiler.compile()
        }).toThrowError(/^At line/)
    })
...
describe('API functions', () => {
    ...
    it('should compile: Function with same name as API but not including it', () => {
        const code = 'long a=0; void Get_B1(void) { a++; }'
        const assembly = '^declare r0\n^declare r1\n^declare r2\n^declare a\n\nCLR @a\nFIN\n\n__fn_Get_B1:\nINC @a\nRET\n'
        const compiler = new SmartC({ language: 'C', sourceCode: code })
        compiler.compile()
        expect(compiler.getAssemblyCode()).toBe(assembly)
