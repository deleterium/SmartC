...
function optimize(assemblySourceCode, maxConstVars) {
    let codeLines = assemblySourceCode.split('\n');
    let jumpToLabels;
    let dest;
    let jmpto, lbl;
    let setdat, opdat, clrdat, popdat;
    let branchdat;
    let pshslpdat;
    let notdat, setdat2;
    let optimizedLines;
            ...
            if (branchdat !== null) {
                ...
                if (lbl !== null && branchdat[4] === lbl[1]) {
                    ...
                    if (jmpto !== null) {
                        ...
                        if (branchdat[1] === 'BGT')
                            instr = 'BLE';
                        else if (branchdat[1] === 'BLT')
                            instr = 'BGE';
                        else if (branchdat[1] === 'BGE')
                            instr = 'BLT';
                        else if (branchdat[1] === 'BLE')
                            instr = 'BGT';
                        else if (branchdat[1] === 'BEQ')
                            instr = 'BNE';
                        else
                            instr = 'BEQ';
