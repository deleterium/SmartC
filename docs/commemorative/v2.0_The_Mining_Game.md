...
## The web site
In the future a web site will show the network status, the the current overall mining factor, best deadline, last winner, last winner and more! Users will have option to link their accounts and deploy, check and control their Miner.
...
//    YYY for MAINNET
#define PICKER_CONTRACT 8749786126809286749
