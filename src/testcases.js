...
var full_tests = [
    ...
    [ "long a;",   false, "^declare a\nFIN\n" ],
    [ "long a=3;", false, "^declare a\nSET @a #0000000000000003\nFIN\n" ],
    [ "long a,b;", false, "^declare a\n^declare b\nFIN\n" ],
    [ "long a,b=3;", false, "^declare a\n^declare b\nSET @b #0000000000000003\nFIN\n" ],
    [ "long * a;",  false, "^declare a\nFIN\n" ],
    [ "long a[3];", false, "^allocate a 3\nFIN\n" ],
    [ "long a[3]; a[0]=9;", false, "^allocate a 3\nSET @r0 #0000000000000009\nSET @($a) $r0\nFIN\n" ],
    [ "long a[3]; a=9;", true, "" ],
    [ "long a; void main(void) { a++; }", false, "^declare a\n\n__fn_main:\nPCS\nINC @a\nFIN\n" ],
    [ "long a; void main(void) { a++; return; }", false, "^declare a\n\n__fn_main:\nPCS\nINC @a\nFIN\n" ],
    [ "long a; void main(void) { a++; return; a++; }", false, "^declare a\n\n__fn_main:\nPCS\nINC @a\nFIN\nINC @a\nFIN\n" ],
    [ "long a; void test(void) { a++; return; }", false, "^declare a\n\nJMP :__fn_test_end\n__fn_test:\nINC @a\nRET\n__fn_test_end:\nFIN\n" ],
    [ "long a; void test(void) { a++; return; a++; }", false, "^declare a\n\nJMP :__fn_test_end\n__fn_test:\nINC @a\nRET\nINC @a\nRET\n__fn_test_end:\nFIN\n" ],
    [ "long a; test(); void test(void) { a++; return; }", false, "^declare a\nJSR :__fn_test\n\nJMP :__fn_test_end\n__fn_test:\nINC @a\nRET\n__fn_test_end:\nFIN\n" ],
    [ "long a; a=test(); void test(void) { a++; return; }", true, "" ],
    [ "long a; void test2(long b) { b++; return; }", false, "^declare a\n\n^declare test2_b\nJMP :__fn_test2_end\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nRET\n__fn_test2_end:\nFIN\n" ],
    [ "long a; long test2(long b) { b++; return b; }", false, "^declare a\n\n^declare test2_b\nJMP :__fn_test2_end\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nPSH $test2_b\nRET\n__fn_test2_end:\nFIN\n" ],
    [ "long a=0; a=test2(a); long test2(long b) { b++; return b; }", false, "^declare a\nCLR @a\nPSH $a\nJSR :__fn_test2\nPOP @r0\nSET @a $r0\n\n^declare test2_b\nJMP :__fn_test2_end\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nPSH $test2_b\nRET\n__fn_test2_end:\nFIN\n" ],
    [ "long a=0; test2(a); long test2(long b) { b++; return b; }", true, "" ],
    [ "#pragma warningToError false\nlong a=0; test2(a); long test2(long b) { b++; return b; }", false, "^declare a\nCLR @a\nPSH $a\nJSR :__fn_test2\nPOP @r0\n\n^declare test2_b\nJMP :__fn_test2_end\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nPSH $test2_b\nRET\n__fn_test2_end:\nFIN\n" ],
    [ "long a=0; void main(void){ a++; test2(a); exit; } void test2(long b) { b++; return; }", false, "^declare a\nCLR @a\n\n__fn_main:\nPCS\nINC @a\nPSH $a\nJSR :__fn_test2\nFIN\n\n^declare test2_b\nJMP :__fn_test2_end\n__fn_test2:\nPOP @test2_b\nINC @test2_b\nRET\n__fn_test2_end:\nFIN\n" ],
    [ "#include APIFunctions\nlong a;Set_A1(a);", false, "^declare a\nFUN set_A1 $a\nFIN\n" ],
    [ "#include APIFunctions\nSet_A1();", true, "" ],
